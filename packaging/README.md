...
- 默认优先：`../ransebao-social-auto-upload`
- 兼容 fallback：`../social-auto-upload`
- 或显式环境变量：`PRODUCT_STUDIO_SAU_SOURCE`

当前建议维护仓库：

- `https://github.com/Shiqi17777-rsq/ransebao-social-auto-upload`
...
```bash
PRODUCT_STUDIO_SAU_SOURCE=/absolute/path/to/ransebao-social-auto-upload npm run build:win
```
